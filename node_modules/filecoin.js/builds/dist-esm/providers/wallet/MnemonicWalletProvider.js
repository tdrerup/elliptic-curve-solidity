...
import { DEFAULT_HD_PATH, TEST_DEFAULT_HD_PATH, MethodInit, MethodMultisig } from "../Types";
...
var MnemonicWalletProvider = /** @class */ (function (_super) {
    ...
    function MnemonicWalletProvider(client, mnemonic, path) {
        ...
        if (path === 'test' || path === '')
            path = TEST_DEFAULT_HD_PATH;
        _this.signer = new MnemonicSigner(mnemonic, '', path);
        return _this;
    }
