...
var keystore_1 = require("../../utils/keystore");
...
var LightWalletProvider = /** @class */ (function (_super) {
    ...
    function LightWalletProvider(client, pwdCallback, path) {
        ...
        _this.hdPathString = Types_1.DEFAULT_HD_PATH;
        _this.pwdCallback = pwdCallback;
        if (path === 'test' || !path)
            _this.hdPathString = Types_1.TEST_DEFAULT_HD_PATH;
        return _this;
    }
    ...
    LightWalletProvider.prototype.createLightWallet = function (password) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.keystore = new keystore_1.Keystore();
                    ...
                    case 1:
                        _a.sent();
                        this.signer = new LightWalletSigner_1.LightWalletSigner(this.keystore);
