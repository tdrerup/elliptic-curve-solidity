...
var scrypt_async_1 = __importDefault(require("scrypt-async"));
...
var Keystore = /** @class */ (function () {
    function Keystore() {
        ...
        this._concatAndSha256 = function (entropyBuf0, entropyBuf1) {
            ...
            return bitcore_lib_1.default.crypto.Hash.sha256(totalEnt);
        };
    }
    ...
    Keystore.prototype.init = function (mnemonic, pwDerivedKey, hdPathString, salt) {
        ...
        if ((typeof pwDerivedKey !== 'undefined') && (typeof mnemonic !== 'undefined')) {
            ...
            var paddedSeed = data_1.leftPadString(mnemonic, ' ', 120);
    ...
    Keystore.prototype.generateSalt = function (byteCount) {
        return bitcore_lib_1.default.crypto.Random.getRandomBuffer(byteCount || 32).toString('base64');
    };
    ;
    Keystore.prototype.isSeedValid = function (seed) {
        return bitcore_mnemonic_1.default.isValid(seed, bitcore_mnemonic_1.default.Words.ENGLISH);
    };
    ;
    Keystore.prototype._encryptString = function (string, pwDerivedKey) {
        ...
        var encStr = tweetnacl_1.default.secretbox(tweetnacl_util_1.default.decodeUTF8(string), nonce, pwDerivedKey);
        return {
            encStr: tweetnacl_util_1.default.encodeBase64(encStr),
            nonce: tweetnacl_util_1.default.encodeBase64(nonce),
        };
    };
    ;
    Keystore.prototype._decryptString = function (encryptedStr, pwDerivedKey) {
        var decStr = tweetnacl_util_1.default.decodeBase64(encryptedStr.encStr);
        var nonce = tweetnacl_util_1.default.decodeBase64(encryptedStr.nonce);
        var decryptedStr = tweetnacl_1.default.secretbox.open(decStr, nonce, pwDerivedKey);
        if (decryptedStr === null) {
            return false;
        }
        return tweetnacl_util_1.default.encodeUTF8(decryptedStr);
    };
    ;
    Keystore.prototype.encodeHex = function (msgUInt8Arr) {
        var msgBase64 = tweetnacl_util_1.default.encodeBase64(msgUInt8Arr);
    ...
    Keystore.prototype.decodeHex = function (msgHex) {
        ...
        return tweetnacl_util_1.default.decodeBase64(msgBase64);
    };
    Keystore.prototype._encryptKey = function (privateKey, pwDerivedKey) {
        var nonce = tweetnacl_1.default.randomBytes(tweetnacl_1.default.secretbox.nonceLength);
        var privateKeyArray = this.decodeHex(privateKey);
        var encKey = tweetnacl_1.default.secretbox(privateKeyArray, nonce, pwDerivedKey);
        return {
            key: tweetnacl_util_1.default.encodeBase64(encKey),
            nonce: tweetnacl_util_1.default.encodeBase64(nonce),
        };
    };
    ;
    Keystore.prototype._decryptKey = function (encryptedKey, pwDerivedKey) {
        var decKey = tweetnacl_util_1.default.decodeBase64(encryptedKey.key);
        var nonce = tweetnacl_util_1.default.decodeBase64(encryptedKey.nonce);
        var decryptedKey = tweetnacl_1.default.secretbox.open(decKey, nonce, pwDerivedKey);
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        ...
                        scrypt_async_1.default(password, salt, {
                            logN: logN,
                            r: r,
                            p: 1,
                            dkLen: dkLen,
    ...
    Keystore.prototype.generateRandomSeed = function (extraEntropy) {
        ...
        if (extraEntropy === undefined) {
            seed = new bitcore_mnemonic_1.default(bitcore_mnemonic_1.default.Words.ENGLISH);
        }
        else if (typeof extraEntropy === 'string') {
            var entBuf = Buffer.from(extraEntropy);
            var randBuf = bitcore_lib_1.default.crypto.Random.getRandomBuffer(256 / 8);
            var hashedEnt = this._concatAndSha256(randBuf, entBuf).slice(0, 128 / 8);
            seed = new bitcore_mnemonic_1.default(hashedEnt, bitcore_mnemonic_1.default.Words.ENGLISH);
        }
        else {
