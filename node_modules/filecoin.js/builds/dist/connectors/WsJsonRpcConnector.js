...
var WsJsonRpcConnector = /** @class */ (function (_super) {
            ...
            if (response.id) {
                ...
                if (response.hasOwnProperty('result')) {
                    ...
                    if (response.error && request.cb) {
                        var error = new Connector_1.JsonRpcError({
    ...
    WsJsonRpcConnector.prototype.connect = function () {
        this.websocket = new isomorphic_ws_1.default(this.fullUrl());
    ...
    WsJsonRpcConnector.prototype.disconnect = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(this.websocket.readyState === isomorphic_ws_1.default.CONNECTING)) return [3 /*break*/, 2];
