...
const search = ({ source, path = "." }) => {
    ...
    return (function () {
        return __asyncGenerator(this, arguments, function* () {
            var e_1, _a, e_2, _b;
            try {
                for (var _c = __asyncValues(source.entries), _d; _d = yield __await(_c.next()), !_d.done;) {
                    ...
                    try {
                        for (var results_1 = (e_2 = void 0, __asyncValues(results)), results_1_1; results_1_1 = yield __await(results_1.next()), !results_1_1.done;) {
