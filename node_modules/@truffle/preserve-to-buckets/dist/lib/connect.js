...
function connect(options) {
    return __asyncGenerator(this, arguments, function* connect_1() {
        ...
        try {
            const buckets = yield __await(hub_1.Buckets.withKeyInfo({ key, secret }));
            const createOrGetResult = yield __await(buckets.getOrCreate(bucketName));
            ...
            return yield __await({ buckets, bucketKey });
        }
        catch (error) {
