...
export declare function abiSignature(abiEntry: Abi.FunctionEntry | Abi.EventEntry): string;
export declare function abiTupleSignature(parameters: Abi.Parameter[]): string;
export declare function abiSelector(abiEntry: Abi.FunctionEntry | Abi.EventEntry): string;
