 ...
 * @public
 */
declare function integer(): _IntegerMock<number>;
/**
 ...
 * @public
 */
declare function integer(max: number): _IntegerMock<number>;
/**
 ...
 * @public
 */
declare function integer(min: number, max: number): _IntegerMock<number>;
/**
 * For integers between min (included) and max (included)
 *
 ...
 * @public
 */
declare function integer(constraints: IntegerConstraints): _IntegerMock<number>;
export { integer };
