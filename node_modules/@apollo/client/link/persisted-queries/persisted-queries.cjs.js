...
var createPersistedQueryLink = function (options) {
    __DEV__ ? tsInvariant.invariant(options && (typeof options.sha256 === 'function' ||
        ...
        typeof options.generateHash === 'function'), 27);
    ...
    return new core.ApolloLink(function (operation, forward) {
        __DEV__ ? tsInvariant.invariant(forward, 'PersistedQueryLink cannot be the last link in the chain.') : tsInvariant.invariant(forward, 28);
